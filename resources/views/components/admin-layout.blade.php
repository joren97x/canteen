...
<body>
    ...
    <div>
        <div class="bg-secondary p-5 container">
            ...
            <h4 class="text-white">Welcome to the hub of possibilities and progress.</h4>
        </div>
    </div>
            ...
            <div class="col-4">
                <div class="list-group">
                    ...
                    <a href="/admin/sales-report">
                        <button type="button" class="list-group-item list-group-item-action {{ request()->is('admin/sales-report') ? 'active' : '' }}">
                            Sales report
                        </button>
                    </a>
